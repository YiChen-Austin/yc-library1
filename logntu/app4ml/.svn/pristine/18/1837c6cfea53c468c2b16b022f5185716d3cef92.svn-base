...
<body>
<div >
<form action="saveSysRole" method="post" id="sysRole">
<br/>
<div id="errorMessage">
</div>
<table class="mainTable">
	<tr>
		...
		<td><input type="text" name="name"
			id="name" value="${sysRoleBean.name }" class="validate[required,custom[chineseEnglishLine],length[0,40]]" /><font color="red">*</font></td>
	</tr>
	<tr>
		<td>角色代码：</td>
		<td><input type="text" name="code"
			id="code" value="${sysRoleBean.code }" class="validate[required,custom[englishNumberLine],length[0,40]]" /><font color="red">*</font></td>
	</tr>
	<tr>
		<td>备注：</td>
...
<tr>
		<td><input type="submit"
			...
			value="重置" style="margin-right: 5px"/><input type="button" value="返回"
			 id="backButton"
