...
<script type="text/javascript" src="<%=path%>/js/ux/system/sys_organization_drag_tree.js"></script>
...
<input type="hidden" name="organizationId" value="${loginUser.organizationId}" id="organizationId"/>
<div id="sysOrganization_tree" style="margin-top: 10px;"></div>
</div>
</fieldset>
