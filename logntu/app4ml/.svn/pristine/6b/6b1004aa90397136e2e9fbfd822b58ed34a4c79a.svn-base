...
<script type="text/javascript" src="<%=path%>/js/ux/news/news_index.js"></script>
						...
						<form id="searchCondition">
							<table class="mainTable">
								<tr>
									...
									<td><input type="hidden" name="loginId" id="loginId" value="${loginUser.id}"/>
									<input type="text" name="commonArticleBean.title" id="title" />
							...
							<table>
								<tr>
									<td><input type="button" value="发布信息" id="sendButton"
