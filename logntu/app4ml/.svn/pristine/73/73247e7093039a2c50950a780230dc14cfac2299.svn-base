...
<script type="text/javascript" src="<%=path%>/js/ux/category/base_category_tree.js"></script>
...
<fieldset class="leftFieldSet"><legend>基础数据分类显示区</legend>
...
<table>
	<tr>
		<td><input type="button" value="同级新增" id="sameLevelCreateButton"
			style="margin-right: 5px" disabled="disabled" class="disableClass"/><input type="button"
			value="次级新增" id="secondaryLevelCreateButton"
			style="margin-right: 5px" disabled="disabled" class="disableClass"/><input type="button"
			value="删除" id="deleteButton" style="margin-right: 5px"
			disabled="disabled" class="disableClass"/></td>
	</tr>
</table>
</div>
<div style="float: left; margin-left: 30px"><br />
<fieldset class="rightFieldSet"><legend>基础数据分类编辑区</legend>
<form id="menuForm">
...
<table style="display: none" id="menuTable" align="center"
	...
	<tr>
		...
		<td><input type="text" name="name" id="name"
			class="validate[required,length[0,40]]" /><font
	...
	<tr>
		<td><label for="nodeImage">图片地址：</label></td>
		<td><input type="text" name="nodeImage" id="nodeImage" class="validate[required]" /></td>
	</tr>
	<tr>
		<td><label for="pageUrl">关键字：</label></td>
		<td><input type="text" name="pageUrl" id="pageUrl" class="validate[required]" />
		</td>
	</tr>
	<tr>
...
<table>
	<tr>
		<td><input type="button" value="保存" id="saveButton"
			style="margin-right: 10px" disabled="disabled" class="disableClass"/></td>
	</tr>
</table>
</div>
</body>
