...
<body>
	...
	<form id="search_form" class="easyui-form" method="post"
		...
		<table cellpadding="5" id="search">
			<tr>
				...
				<input type="hidden" name="rtype" id="rtype" value="" /></input></td>
			</tr>
		</table>
	...
	<div id="checkup_tags" name="tags" class="tags">
		<ul>
			<li class="selectTag"><a name="order_unrefund_div" id="order_unrefund_div">待平台退款</a></li>
			<li><a name="order_refund_div" id="order_refund_div">平台成功退款</a></li>
		</ul>
	</div>
	<!-- tags_end -->
	<div id="checkUp" name="checkup_tab_box" class="tagContent">
		<table id="dg" class="easyui-datagrid" title="退款订单列表"
			...
			data-options="singleSelect:true,collapsible:true,pagination:true,rownumbers:true,autoRowHeight:true,url:'/admin/order/refunds',method:'post',pageSize:20">
			<thead>
				<tr>
					...
					<th data-options="field:'creduce',width:50,sortable:true">券抵扣</th>
	...
	<script type="text/javascript">
		function exportData() {
			window.location = "/admin/order/expRefund?"+$("#search_form").serialize();
		}
		function doMore() {
		...
		$(function() {
			...
			//绑定选择
			$("#order_unrefund_div").bind('click', alterTag);
