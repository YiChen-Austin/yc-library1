...
<script type="text/javascript"
	src="<%=path%>/js/ux/project/project_hot_list.js"></script>
<script type="text/javascript"
	...
	<div style="margin-top: 40px;">
		...
		<div id="checkup_tags" name="tags" class="tags">
			<ul>
				...
				<li class="selectTag"><a name="P_Normal" id="P_Normal">普通项目</a></li>
				<li><a name="P_Recommend" id="P_Recommend">推荐项目</a></li>
				<li><a name="P_Hot" id="P_Hot">热门项目</a></li>
				<li><a name="P_Illegal" id="P_Illegal">违规项目</a></li>
			</ul>
		</div>
		<!-- tags_end -->
