...
<script type="text/javascript"
	src="<%=path%>/js/ux/activity/activity_lr_list.js"></script>
<script type="text/javascript"
...
<body>
	<div style="margin-left: 20px;">
		...
		<form id="searchActivityForm" style="margin-left: 0px;">
			<table>
				<tr>
					<td><label for="title">活动标题：</label> <input type="text"
						class="inputbox" name="title" id="activity_title" /></td>
					<td><input class="BtnAction" type="submit" value="查询"
						id="searchActivityButton" /><input class="BtnAction" type="button"
		...
		<table>
			<tr>
				<td><input type="button" id="singleActivityButton" value="查看"
					style="margin-right: 5px" /> <input type="button"
					id="saveActivityButton" value="新增" style="margin-right: 5px" /> <input
					type="button" id="updateActivityButton" value="修改"
					style="margin-right: 5px" /> <input type="button"
					id="deleteActivityButton" value="删除" style="margin-right: 5px" /></td>
			</tr>
		</table>
	</div>
</body>
