...
<script type="text/javascript"
	src="<%=path%>/js/ux/news/news_lr_edit.js"></script>
<script type="text/javascript"
...
<body>
	<div>
		<form method="post" action="saveNews" id="newsDetail">
			<br />
			<div id="errorMessage">
				<s:fielderror />
				<s:actionerror />
				...
				<table class="info">
					...
					<tr>
						<td class="ftt2"><label for="categoryId">分类：<font
								color="red">*</font></label></td>
						<td colspan="3">${newsBean.categoryName}</td>
					</tr>
					<tr>
						<td class="ftt2"><label for="imgUrl">封面图片：</label></td>
						<td colspan="3"><img src="${newsBean.imgUrl}"
							alt="图片" style="width: 30px; height: 30px;" /></td>
					</tr>
					<tr>
						<td class="ftt2"><label for="artAbstract">摘要：<font
								color="red">*</font></label></td>
						<td colspan="3">${newsBean.artAbstract}</td>
					</tr>
					<tr>
						<td class="ftt2"><label for="artContent">内容：</label></td>
						<td colspan="3">${newsBean.artContent}</td>
					</tr>
					<tr>
						<td class="ftt2"><label for="artContent">标签：</label></td>
						<td colspan="3">${newsBean.tag}</td>
					</tr>
				</table>
			</fieldset>
			<table>
				<tr>
					<td><input type="button" value="返回" id="backNewsButton"
