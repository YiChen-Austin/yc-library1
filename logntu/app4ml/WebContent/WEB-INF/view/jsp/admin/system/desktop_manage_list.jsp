...
<script type="text/javascript" src="<%=path%>/js/ux/system/desktop_manage_list.js"></script>
...
<table class="mainTable">
	<tr>
		...
		<td><input type="text" name="title"
			id="title" /></td>
		<td><label for="divId">DIV标签ID： </label></td>
		<td><input type="text" name="divId"
			id="divId" /></td>
...
<table id="desktopDefendList"></table>
<div id="pager"></div>
<table>
	<tr>
