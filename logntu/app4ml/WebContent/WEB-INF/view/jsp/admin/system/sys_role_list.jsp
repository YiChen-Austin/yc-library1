...
<script type="text/javascript" src="<%=path%>/js/ux/system/sys_role_list.js"></script>
...
<table class="mainTable">
	<tr>
		<td>角色名称：</td>
		<td width="130px"><input type="text" name="name"/></td>
		<td><input type="button" value="查询" id="searchButton"
				style="margin-right: 5px"/><input type="button" value="重置" id="resetButton"
...
<table>
	<tr>
		<td><input type="button" id="createButton"
			value="新增" style="margin-right: 5px"/><input type="button" id="updateButton"
			value="修改" style="margin-right: 5px"/><input type="button" id="deleteButton"
			value="删除" style="margin-right: 5px"/></td>
	</tr>
</table>
</div>
</body>
