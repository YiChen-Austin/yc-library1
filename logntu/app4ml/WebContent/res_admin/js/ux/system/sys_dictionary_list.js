$(function() {
	...
	jQuery("#sysDictionaryList").jqGrid(
			{
				url : $("#path",parent.document).val()+"/admin/"+'findAllSysDictionaries',
				datatype : "json",
	...
	$("#createButton").click(function() {
		window.location = $("#path",parent.document).val()+"/admin/"+"createSysDictionary";
	});
	// 修改功能
	$("#updateButton").click(function() {
		...
		window.location = $("#path",parent.document).val()+"/admin/"+"findSysDictionary?id=" + sysDicId;
	});
	// 删除功能
	$("#deleteButton").click(function() {
		...
		if(!confirm('真的要删除吗？删除后将无法恢复!')){      
			...
			jQuery("#sysDictionaryList").jqGrid('setGridParam', {
				type : "post",
				datatype : "json",
				url : $("#path",parent.document).val()+"/admin/"+"deleteSysDictionary?deleteIDs=" + sysDicId,
				page : 1
			}).trigger("reloadGrid");
