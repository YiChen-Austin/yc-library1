...
//		String strReg = "101100-WEB-HUAX-888876";   //注册号（由华兴软通提供）
//        String strPwd = "DMXTMLMW";                 //密码（由华兴软通提供）
//        String strSourceAdd = "";                   //子通道号，可为空（预留参数一般为空）
//       // String strTim = HttpSend.paraTo16("2012-2-16 12:00:00"); //定时发送时间
//        String strPhone = "18716393365";//手机号码，多个手机号用半角逗号分开，最多1000个
//       // String strContent = OldHttpSendSms.paraTo16("你收到的验证码为：8739,如需帮助请联系客服.【全球狗】");       //短信内容
//        
...
//        
//        //查询余额
//        strRes = OldHttpSendSms.postSend(strBalanceUrl, strBalanceParam);
//        System.out.println(strRes);
//        //发送短信
//       strRes = OldHttpSendSms.postSend(strSmsUrl, strSmsParam);
//        
//        //定时短信
